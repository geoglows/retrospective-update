...
from set_env_variables import (
    ...
    MONTHLY_TIMESTEPS, MONTHLY_TIMESERIES, S3_MONTHLY_TIMESTEPS, S3_MONTHLY_TIMESERIES,
)
...
if __name__ == '__main__':
    ...
    try:
        ...
        check_local_zarrs_match_s3(MONTHLY_TIMESERIES, S3_MONTHLY_TIMESERIES)
        check_local_zarrs_match_s3(MONTHLY_TIMESTEPS, S3_MONTHLY_TIMESTEPS)
