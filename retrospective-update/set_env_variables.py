...
S3_HYDROSOS_THRESHOLDS = os.getenv('S3_HYDROSOS_THRESHOLDS')
HYDROSOS_BASINS = os.getenv('HYDROSOS_BASINS')
S3_HYDROSOS_BASINS = os.getenv('S3_HYDROSOS_BASINS')
HYDROSOS_ID_PAIRS = os.getenv('HYDROSOS_ID_PAIRS')
S3_HYDROSOS_ID_PAIRS = os.getenv('S3_HYDROSOS_ID_PAIRS')
...
S3_MONTHLY_TIMESERIES_ZARR = os.getenv('S3_MONTHLY_TIMESERIES')
S3_MONTHLY_TIMESTEPS_ZARR = os.getenv('S3_MONTHLY_TIMESTEPS')
